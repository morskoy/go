<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	'method'=>'get',
		...
		<table>
			<tr>
				<td><?php echo $form->textFieldRow($model,'id',array('class'=>'span1')); ?></td>
				<td><?php
			...
			<tr>
				<td colspan=3> <?php echo $form->dateRangeRow($model,'date_start',array(
						'class'=>'span3',
                ...
                <td colspan=2>
                	<?php echo $form->dateRangeRow($model,'date_finish',array(
						'class'=>'span3',
						'prepend'=>'<i class="icon-calendar"></i>',
						'options' => array(
							'language' => Yii::app()->language,
