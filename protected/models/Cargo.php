...
class Cargo extends CActiveRecord
{
	...
	public function rules()
	{
        ...
        return array(
            ...
            array('id, user_id, country_start_id, city_start, postal_code_start, date_start, correction_start, country_finish_id, city_finish, postal_code_finish, date_finish, correction_finish, dop_info, date_add, visible', 'safe', 'on'=>'search'),
        );
	}
	...
	public function attributeLabels()
	{
        return array(
            ...
            'date_start' => Yii::t('site','Date of departures'),
